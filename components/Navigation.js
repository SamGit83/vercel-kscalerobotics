          ...
          <div ref={contactRef} style={{ position: 'relative' }}>
            ...
            {isContactOpen && (
              <div className={styles.contactDropdown}>
                ...
                <a href="https://x.com/kscalerobotics" target="_blank" rel="noopener noreferrer" className={styles.dropdownLink} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>𝕏</a>
              </div>
            )}
          </div>
        </div>
